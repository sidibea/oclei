				...
				'global'    => array(
					...
					'options' => array(
						...
						'divider_api_1'   => array(
							'type' => 'divider',
							'data' => array(
								'title' => esc_html__('Google API settings', 'pearl'),
								'value' => ''
							)
						),
						'google_api_key'  => array(
							'type' => 'text',
							'data' => array(
								'title' => esc_html__('Google API key', 'pearl'),
								'value' => ''
							)
						),
						'ga'              => array(
							'type' => 'text',
							'data' => array(
								'title' => esc_html__('Google analytics ID', 'pearl'),
								'value' => ''
							)
						),
					)
										...
										'<form>
											<div class="form-group">
												<div>
													...
													<input type="text" class="form-control" placeholder="' . esc_html__('Your name', 'pearl') . '">
												</div>
											</div>
											<div class="form-group">
												<div>
													<span class="label" style="display: none">' . esc_html__('Your phone', 'pearl') . '</span>
													<input type="tel" class="form-control" placeholder="' . esc_html__('Your phone', 'pearl') . '">
												</div>
											</div>
											<div class="form-group">
